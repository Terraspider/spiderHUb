 ...
 * core.c
 *
 * This code contain all API related to BBG core file system.
 */
...
int get_device_tree_overlay_count() {
	...
	FILE *fh = fopen("/sys/devices//platform/bone_capemgr/slots", "r");
...
int init_bbc_lib() {
	...
	slotsFilePath = "/sys/devices//platform/bone_capemgr/slots";
	return 0;
}
