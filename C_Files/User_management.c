...
int add_User_id()
{
	...
	FILE *fptr = fopen("/SpiderHub/UserID_Database/registered_user_ids.txt","a+");
	if (fptr == NULL)	{
...
int userid_auth()
{
  ...
  if((flag_boot_userid_update == 1) || (flag_userid_update == 1))	{
	 ...
	 FILE *idvar = fopen("/SpiderHub/UserID_Database/registered_user_ids.txt", "r");
	 ...
	 fclose(idvar);
	 idvar = fopen("/SpiderHub/Flags/flag_user_ids.txt", "w+");
...
////////////////// Opening File ////////////////////////
	...
	FILE *fp3 = fopen("/SpiderHub/UserID_Database/registered_user_ids.txt", "r+b");
	if (fp3 == NULL ) {
...
//////////////// Removing old File////////////////////////////
	...
	if (remove("/SpiderHub/UserID_Database/registered_user_ids.txt") == 0){}
...
////////// create new file ///////////////////////////
	...
	fp3 = fopen("/SpiderHub/UserID_Database/registered_user_ids.txt", "w");
	if (fp3 == NULL ) {
		printf("Could not open file for user id deletion\n");
		return 1;
	} else
